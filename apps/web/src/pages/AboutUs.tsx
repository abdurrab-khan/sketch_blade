        ...
        <div className="mx-auto max-w-5xl px-6">
          ...
          >
            ...
            <div className="group perspective-1000 relative">
              ...
              >
                <div className="relative flex aspect-[4/3] w-full flex-col items-center justify-center overflow-hidden rounded-xl border border-slate-700/50 bg-gradient-to-br from-slate-900 to-slate-950">
          ...
          {values.map((item, index) => {
            ...
            return (
              <motion.div
                ...
                className="group flex flex-col items-start gap-6 rounded-[2rem] border border-slate-800 bg-slate-900/40 p-8 backdrop-blur-xl transition-all duration-300 hover:bg-slate-800/60 hover:shadow-2xl sm:flex-row"
              >
                <div
                  className={`shrink-0 rounded-2xl bg-gradient-to-br p-4 shadow-lg ${item.color} text-white transition-transform duration-300 group-hover:scale-110`}
                >
                  <Icon size={28} />
                </div>
                <div>
